  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="currency">
    <div class="btn-group">
      <button class="btn btn-link dropdown-toggle" data-toggle="dropdown">
        ...
        <img id="cur" class="flag <?php echo strtolower(substr($currency['code'], 0, 2)); ?>"/>&nbsp;
        <span class="hidden-xs hidden-sm hidden-md"><?php echo $currency['title']; ?></span> <i class="fa fa-caret-down"></i>
